...
TEST(correctness, string_cast) {
    EXPECT_EQ((std::string) big_integer("100"), "100");
    EXPECT_EQ((std::string) big_integer("0100"), "100");
    EXPECT_EQ((std::string) big_integer("0"), "0");
    EXPECT_EQ((std::string) big_integer("-0"), "0");
    EXPECT_EQ((std::string) big_integer("-1000000000000000"), "-1000000000000000");
}
