...
void testBiDivRem() {
    ...
    b4 = biFromString("6703903964971298549787012499102923063739682910296196688861780721860882015023660034294811089951732299792782023528860199663493147528504713584320662571322642");
    b2 = biFromString("6703903964971298549787012499102923063739682910296196688861780721860882015023660034294811089951732299792782023528860199663493147528504713584320662571322642");

    b3 = biFromString("57896044618658097711785492504343953926634992332820282019728792003956564819949");
    BigInt b5 = biFromString("57896044618658097711785492504343953926634992332820282019728792003956564819949");

    biDivRem(quotient, remainder, b2, b3);
    assert(biCmp(b2, b4) == 0);
    assert(biCmp(b3, b5) == 0);

    biMul(*quotient, b3);
    biAdd(*quotient, *remainder);
    assert(biCmp(*quotient, b2) == 0);
    cerr << "THE END" << endl;
    ...
    b3 = biFromString("57896044618658097711785492504343953926634992332820282019728792003956564819949");
    b5 = biFromString("57896044618658097711785492504343953926634992332820282019728792003956564819949");
